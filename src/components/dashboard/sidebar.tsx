...
export function AdminSidebar() {
  ...
  return (
    <>
      ...
      <aside className="hidden lg:flex lg:w-64 flex-col border-r-2 border-slate-200/80 bg-white h-full shadow-sm">
        {/* Logo Area - Fixed at top */}
        <div className="p-4 border-b-2 border-slate-200 flex-shrink-0 bg-white">
        ...
        <div className="p-4 border-t-2 border-slate-200 flex-shrink-0 bg-white">
          <Link href="/">
            <Button
              variant="ghost"
          ...
          <div className="mt-4 pt-3 border-t-2 border-slate-200">
            <div className="flex items-center justify-between">
              ...
              <Badge className="bg-emerald-100 text-emerald-700 border-2 border-emerald-200 text-[10px] font-bold px-2 py-0.5 rounded-lg">
