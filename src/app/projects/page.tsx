...
const projects = [
  {
    title: "Project One",
    description:
      "A brief description of the first project, highlighting the key technologies and challenges.",
  ...
  },
  {
    title: "Project Two",
    description:
      "A brief description of the second project, focusing on the outcomes and user impact.",
  ...
  },
  {
    title: "Project Three",
    description:
      "A brief description of the third project, detailing the unique features and architecture.",
        ...
        <div className="container mx-auto max-w-6xl px-4 py-16 md:py-24">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {projects.map((project) => (
              <Card
                key={project.title}
                className="group flex flex-col overflow-hidden bg-slate-900/50 border-slate-800/50 transition-all duration-300 hover:border-blue-500/50 hover:shadow-2xl hover:shadow-blue-900/20 hover:-translate-y-1"
              >
