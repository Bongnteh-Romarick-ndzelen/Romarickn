      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid lg:grid-cols-2 gap-8 items-start">
          ...
          <div className="space-y-6">
            ...
            {/* Availability */}
            <div className="bg-white border-2 border-slate-200/80 rounded-2xl p-6 text-center shadow-sm hover:shadow-md transition-all">
            ...
            {/* Hobbies */}
            <div className="bg-white border-2 border-slate-200/80 rounded-2xl p-6 shadow-sm hover:shadow-md transition-all">
          ...
          <div className="space-y-6">
            {/* Bio */}
            <div className="bg-white border-2 border-slate-200/80 rounded-2xl p-8 shadow-sm hover:shadow-md transition-all">
              <h3 className="text-xl font-bold text-slate-900 mb-5 flex items-center gap-2">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 pb-20">
        <div className="bg-gradient-to-r from-blue-50 to-indigo-50 border-2 border-blue-200/60 rounded-2xl p-10 text-center shadow-sm">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/projects">
              <button className="px-10 py-4.5 bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white text-lg font-bold rounded-xl shadow-lg shadow-blue-600/25 transition-all">
                View My Work →
              </button>
            </Link>
            <Link href="/contact">
              <button className="px-10 py-4.5 border-2 border-slate-300 text-slate-700 hover:bg-slate-50 text-lg font-bold rounded-xl transition-all">
